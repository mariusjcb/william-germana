...
export default function SettingsPage() {
  ...
  const handleExport = async () => {
    ...
    a.href = url;
    a.download = `romanianmeister-backup-${new Date().toISOString().split('T')[0]}.json`;
    a.click();
      ...
      <div className="bg-surface rounded-2xl p-5 shadow-sm border border-border-light">
        ...
        <div className="space-y-2">
          {[
            ...
            { value: 'ro-en' as const, label: 'Romanian \u2192 English', desc: 'See Romanian, guess English' },
            { value: 'en-ro' as const, label: 'English \u2192 Romanian', desc: 'See English, guess Romanian' },
          ].map((opt) => (
            <button
              key={opt.value}
